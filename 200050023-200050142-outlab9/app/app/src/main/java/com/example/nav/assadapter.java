...
public class assadapter extends RecyclerView.Adapter<assadapter.myviewholder>{

    ArrayList<model_ass> dataholder;
    DBHelper db;

    public assadapter(ArrayList<model_ass> dataholder, DBHelper db) {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ass,parent,false);
        ...
        public myviewholder(@NonNull View itemView) {
            ...
            mdelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    final Boolean abool=db.del_ass(dataholder.get(getAdapterPosition()).getId());
